...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "Некорректная дата снятия показаний.": "Invalid reading date.",
        "Дата снятия показаний не может быть в будущем.": "The reading date cannot be in the future.",
        "Дата снятия показаний не может быть раньше {date} — даты предыдущего показания (или установки счётчика).":
            "The reading date cannot be earlier than {date} — the date of the previous reading (or of the meter installation).",
        "Месяц": "Month",
        ...
        "Смета": "Budget",
        "утверждена": "approved",
        "не утверждена": "not approved",
        "Годовых отчётов пока нет. Составить отчёт можно со страницы собрания, отмеченного как годовое отчётное.": "No annual reports yet. You can create one from the page of a meeting marked as the annual reporting meeting.",
        "Изменить годовой отчёт": "Edit annual report",
        "Новый годовой отчёт": "New annual report",
        "Собрание от {date}": "Meeting on {date}",
        "Смета на следующий год, ₽": "Budget for next year, RUB",
        "Смета утверждена собранием": "Budget approved by the meeting",
        "Отчёт о расходах (файл)": "Spending report (file)",
        "текущий файл": "current file",
        "Финансовая отчётность (файл)": "Financial statements (file)",
        "Загрузка нового файла заменяет прежний. Если файл не выбран, ранее загруженный сохраняется.": "Uploading a new file replaces the previous one. If no file is chosen, the previously uploaded one is kept.",
        "Ставки взносов на следующий год": "Fee rates for next year",
        "Вид взноса": "Fee type",
        "Ставка, ₽/м²": "Rate, RUB/m²",
        "Фиксированная сумма, ₽": "Fixed amount, RUB",
        "Заполняйте только те виды взноса, ставку которых утвердило собрание. Пустая строка — ставка не меняется.": "Fill in only the fee types whose rate was approved by the meeting. An empty row means the rate is unchanged.",
        "Годовой отчёт сохранён.": "Annual report saved.",
        "Годовой отчёт за {year} год": "Annual report for {year}",
        "Смета на следующий год": "Budget for next year",
        "Отчёт о расходах": "Spending report",
        "Отчёт о расходах за {year} год": "Spending report for {year}",
        "скачать": "download",
        "Финансовая отчётность": "Financial statements",
        "Финансовая отчётность за {year} год": "Financial statements for {year}",
        "Открыть отчёт": "Open report",
        "Составить отчёт": "Create report",
        ...
        "Отменить разнесение? Платёж будет удалён с лицевого счёта, запись можно будет разнести заново.":
            "Undo the allocation? The payment will be removed from the personal account; the entry can be allocated again.",
        "Эта операция не разнесена.": "This transaction is not allocated.",
        "Эта запись не разнесена.": "This entry is not allocated.",
        "Разнесение отменено — операцию можно разнести заново.": "Allocation undone — the transaction can be allocated again.",
        "Разнесение отменено — запись можно разнести заново.": "Allocation undone — the entry can be allocated again.",
        ...
        "без пени": "excluding penalty",
        "Итого задолженность (со всеми пенями)": "Total debt (including penalties)",
        "Сумма к погашению": "Amount due",
...
DOC_TYPE_LABELS = {
    "ru": {
        ...
        "estimate": "смета", "report": "отчёт", "agreement": "соглашение", "contract": "договор", "other": "прочее",
    },
    "en": {
        ...
        "estimate": "estimate", "report": "report", "agreement": "agreement", "contract": "contract", "other": "other",
    },
}
